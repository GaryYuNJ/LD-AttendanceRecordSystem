...
<div class="">
	...
	<div class="page-head">
		<h2 class="pull-left">
			<i class="icon-home"></i> 月报表页面
		</h2>
		<!-- Breadcrumb -->
		<div class="bread-crumb pull-right">
			<a href="index.html"><i class="icon-home"></i> 月报表页面</a>
			<!-- Divider -->
			<span class="divider">/</span> <a href="#" class="bread-current">月报表</a>
		</div>
...
<script src="<c:url value="/js/attendance_print_list.js" />"></script>
